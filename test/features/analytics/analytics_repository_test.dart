...
void main() {
  ...
  group('AnalyticsRepositoryImpl Tests', () {
    test('Calculates financial summary and excludes transfers from expense totals', () async {
      ...
      final result = await analyticsRepository.getAnalytics(AnalyticsPeriod.thisMonth);
      ...
      expect(summary.topCategories.first.percentage, equals(60.0)); // 3M / 5M * 100% = 60%
    });
  });
}
