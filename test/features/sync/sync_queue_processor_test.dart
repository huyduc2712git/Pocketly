...
void main() {
  ...
  group('SyncQueue Processor Tests', () {
    test(
      'Process pending queue items successfully updates status to synced',
      () async {
        ...
        expect(
          pendingList.dataOrNull!.first.status,
    ...
    test(
      'Process with failure increments retry count and sets error message',
      () async {
        await db
            .into(db.syncQueueTable)
            .insert(
        ...
        expect(
          pendingList.dataOrNull!.first.lastError,
