...
void main() {
  ...
  group('ProcessDueRecurringTransactionsUseCase Tests', () {
    test('Processes due monthly recurring transaction, deducts wallet balance, and advances next date', () async {
      ...
      final updatedRec = allRecurring.dataOrNull!.firstWhere((r) => r.id == 'rec_rent');
